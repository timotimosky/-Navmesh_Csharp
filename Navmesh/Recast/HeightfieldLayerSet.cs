namespace org.recast4j.recast
{
	...
	public class HeightfieldLayerSet
	{
		...
		{
			public readonly float[] bmin = new float[3]; ///< The minimum bounds in world space. [(x, y, z)]
			public readonly float[] bmax = new float[3]; ///< The maximum bounds in world space. [(x, y, z)]
