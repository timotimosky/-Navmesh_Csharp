...
//	import static org.recast4j.recast.RecastConstants.RC_NULL_AREA;
	...
	public class RecastArea
	{
		...
		internal static bool pointInPoly(float[] verts, float[] p)
		{
			bool c = false;
			int i, j;
		...
		internal virtual int offsetPoly(float[] verts, int nverts, float offset, float[] outVerts, int maxOutVerts)
		{
