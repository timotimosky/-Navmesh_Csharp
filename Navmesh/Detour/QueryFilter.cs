...
//	import static org.recast4j.detour.DetourCommon.vDist;
	...
	/// </summary>
	/// <seealso cref= NavMeshQuery </seealso>
	public class QueryFilter
	{

		private int m_excludeFlags;
		private int m_includeFlags;
		internal float[] m_areaCost = new float[NavMesh.DT_MAX_AREAS];
		...
		public virtual bool passFilter(long @ref, MeshTile tile, Poly poly)
		{
